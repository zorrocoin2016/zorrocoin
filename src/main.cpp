...
int64 nChainStartTime = 1462414330;
...
const string strMessageMagic = "ZorroCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    else if(nHeight > 1000 && nHeight <= 36000)
    {
        nSubsidy = 0.0 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ZorroCoin
    bool fStrictPayToScriptHash = true; // Always active in ZorroCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZorroCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "trace how Genesis bloc back gg it was in the sende";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 759993 : 759993;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xce9b013bd781539fb9a5d80d5bb43682b1df88f66d6e0b35cf8aaac940ffa80b"));
...
unsigned char pchMessageStart[4] = { 0x7c, 0xea, 0x5d, 0xbd };
